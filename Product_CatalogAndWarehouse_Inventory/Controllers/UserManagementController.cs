...
namespace Product_CatalogAndWarehouse_Inventory.Controllers
{
    public class UserManagementController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Login(UserModel userModel, string Email, string password)
        {
            obj_dal = new Dal();
            sb = new StringBuilder();
            ...
            if (Count == 1)
            {
                ...
                //return RedirectToAction("UserList");
                if (Email.Equals(userModel.Email) && password.Equals(userModel.Password))
                {
            ...
            else
            {
                // Error message in red color
                ViewBag.color = "red";
                ViewBag.Message = "Wrong Email ID and password";
            }
